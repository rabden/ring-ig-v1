export const styleConfig = {
  ...
  cinematic: {
    name: "Cinematic",
    suffix: "cinematic, movie scene, film still, dramatic lighting, widescreen, atmospheric, cinematic composition, film grade, movie quality",
    isPremium: false
  },
  isometric: {
    name: "Isometric",
  ...
  storybook: {
    name: "Storybook",
    suffix: "children's book illustration, whimsical, playful, storybook style, cute, colorful, narrative art, picture book, kid-friendly",
    isPremium: false
  },
  steampunk: {
    name: "Steampunk",
