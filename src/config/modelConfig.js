export const modelConfig = {
  flux: {
    ...
    example: "Make high quality prompts with clear and concise details, in the prompt describe avaerything in detail while keeping it in medium length, Use artistic tags that are appropriate for the prompt you make",
    steps: 4,
    use_guidance: false,
    defaultguidance: 7.5,
  ...
  surreal: {
    ...
    example: "tailor prompt to be surreal",
    steps: 28,
    use_guidance: false,
    defaultguidance: 7.5,
    use_negative_prompt: false,
  ...
  asianbeauty: {
    ...
    promptSuffix: null,
    tagline: "make distilled Cinematic scenes",
    image: "https://i.ibb.co.com/Tqs8PQD/c2215bd73da9f14fcd63cc93350e66e2901bdafa6fb8abaaa2c32a1b.jpghttps://i.ibb.co.com/ZWYt9Vz/ea2.webp",
