      ...
      <div className="relative">
        <div className="relative">
          ...
          <textarea
            ...
            className="w-full min-h-[180px] md:min-h-[306px] resize-none bg-transparent text-lg focus:outline-none placeholder:text-muted-foreground/50 overflow-y-auto scrollbar-none border-y border-border/20 py-8 px-4"
            style={{ 
